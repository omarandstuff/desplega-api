...
export default class Step<D = StepDefinition> {
  ...
  public async run(context: Context): Promise<any> {
  ...
  //     ? {
  //         text: ` SUB STEP `,
  //         style: this.context.theme.subStepStatusContrastStyle ? this.context.theme.subStepStatusContrastStyle.bold : undefined
  //       }
  //     : {
  //         text: ` ${successWord} `,
